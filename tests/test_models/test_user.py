...
class TestUser(unittest.TestCase):
    ...
    def test_str_model(self):
        """ Test if group 1 exists and is of type User """
        b = User()
        rec = re.compile("^\[(.*)] \((.*)\) (.*)$")
        reb = rec.match(str(b))
        self.assertEqual(reb.group(1), "User")
    ...
    def test_to_dict_name(self):
        """ Test if name is implemented into User """
        b = User()
        b.name = "scoot"
        d = b.to_dict()
    ...
    def test_to_dict_id(self):
        """ Test if id is implemented into User """
        b = User()
        d = b.to_dict()
        self.assertEqual(d["id"], b.id)

    def test_to_dict_created_at(self):
        """ Test if created_at is implemented into User """
        b = User()
        d = b.to_dict()
        self.assertEqual(d["created_at"], b.created_at.isoformat())

    def test_to_dict_updated_at(self):
        """ Test if updated_at is implemented into User """
        b = User()
        d = b.to_dict()
